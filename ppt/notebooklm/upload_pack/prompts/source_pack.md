...
|---|---:|---:|---:|---:|---:|---:|---:|
| BPR-MF | 0.0222 | 0.0079 | 0.0048 | 0.0400 | 0.6249 | 0.6924 | 0.7420 |
| ItemCF | 0.0421 | 0.0156 | 0.0109 | 0.0800 | 0.5092 | 0.7641 | 0.6457 |
| Ours-Full | 0.1291 | 0.1273 | 0.1815 | 0.2300 | 0.1846 | 0.9218 | 0.2714 |
| Popular | 0.0529 | 0.0249 | 0.0233 | 0.1100 | 0.0075 | 0.9941 | 0.0000 |
| Random | 0.0294 | 0.0143 | 0.0131 | 0.0633 | 0.1507 | 0.8738 | 0.0000 |
| Repeat | 0.1542 | 0.1413 | 0.1967 | 0.2767 | 0.1168 | 0.9789 | 0.4290 |
| UserOnly | 0.1753 | 0.1486 | 0.2013 | 0.2867 | 0.1819 | 0.9268 | 0.2754 |

结果解读：

- `UserOnly` 是离线命中最强策略，说明用户复购、品类偏好、价格和时段特征有效。
- `Repeat` 表现强，符合外卖场景复购明显的特征。
- `Ours-Full` 的 Recall@20 低于 UserOnly，但保留了明显高于 Popular、Random、ItemCF、BPR-MF 的推荐效果。
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Popular + Nearest | 58 | 79.89 | 0.7586 | 0.2414 | 1.0246 | 0.5069 | 0.3492 |
| UserOnly + Nearest | 83 | 95.25 | 0.8675 | 0.1325 | 1.1532 | 0.7217 | 0.3707 |
| UserOnly + MinETA | 78 | 53.35 | 0.6282 | 0.3718 | 0.6665 | 0.7321 | 0.4450 |
| Ours w/o Fairness | 79 | 52.05 | 0.5823 | 0.4177 | 0.6123 | 0.7494 | 0.4702 |
| Ours-Full | 76 | 45.54 | 0.4605 | 0.5395 | 0.6046 | 0.7105 | 0.4948 |

结果解读：

- `UserOnly + Nearest` 虽然用户满意度高，但平均 ETA 高达 95.25，超时率 0.8675，说明只优化用户命中可能制造履约压力。
- `UserOnly + MinETA` 显著降低 ETA 和超时率，说明订单推荐给骑手时需要考虑 ETA。
- `Ours-Full` 平均 ETA 最低，为 45.54；超时率最低，为 0.4605；平台综合效用最高，为 0.4948。
