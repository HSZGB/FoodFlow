...
- 如果第 6 页空间允许，加入 `offline_category_jsd20.png`，说明推荐列表的品类分布是否贴近用户历史偏好。
- 第 8 页至少使用 `simulation_avg_eta.png` 和 `simulation_platform_utility.png`。
- 如果第 8 页空间允许，优先加入 `pareto_recall_utility.png`，说明 Seq-Tuned 是离线准确率前沿、Seq-xQuAD-Tripartite 是平台效用前沿。
