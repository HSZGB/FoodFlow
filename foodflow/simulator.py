...
from .rider_sim import assign_order, assign_orders_batch, generate_riders, update_rider_after_assignment
    ...
    for policy_index, policy in enumerate(policies, start=1):
        ...
        for step in range(steps):
            ...
            for user_id in request_users:
                ...
                chosen = _choice_model(recs, rec_result.scores.get(user_id, {}), truth.get(user_id, set()), rng)
            ...
            if assignment_mode == "batch" and pending_orders:
                ...
                for _, assignment in assignments.iterrows():
                    ...
                    update_rider_after_assignment(riders, str(assignment["rider_id"]), eta, current_time)
                    completed += 1
                    etas.append(eta)
                    timeouts += int(eta > 45.0)
                    satisfaction.append(float(order["satisfaction"]))
